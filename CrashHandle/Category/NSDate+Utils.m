...
+ (NSDate *) dateWithDaysFromDate:(NSDate *)date addDays:(NSInteger) days
{
...
+ (NSDate *)zhDateFromString:(NSString *)string withFormat:(NSString *)format
{
    NSDateFormatter *inputFormatter = [[NSDateFormatter alloc] init];
    [inputFormatter setDateFormat:format];
    NSDate *date = [inputFormatter dateFromString:string];
    
    NSTimeZone *zone = [NSTimeZone systemTimeZone];//获取本地时间
    NSTimeInterval timeN = [zone secondsFromGMTForDate:date];
    NSDate *dateNow = [date dateByAddingTimeInterval:timeN];
